...
public class DocumentoPropuestaTest {
	...
	documentoPropuesta = new DocumentoPropuesta(CODIGO,NOMBRE_DOCUMENTO,FECHA_CREACION,DOCUMENTO_PUBLICO,EstadoDocumento.ACTIVO, CODIGOPROPUESTA, EJERCICIO, GRUPOPOLITICO);
	}
